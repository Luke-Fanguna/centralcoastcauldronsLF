...
def get_wholesale_purchase_plan(wholesale_catalog: list[Barrel]):
    ...
    for barrel in wholesale_catalog:
        if barrel.potion_type == [1,0,0,0]:
            if barrel[0] <= 5000 and   (barrel.price * barrel.quantity) < wallet:
                purchased.append(
                    {
                        "sku": barrel.sku,
            ...
            if barrel[1] <= 5000 and  (barrel.price * barrel.quantity) < wallet:
                purchased.append(
                    {
                        "sku": barrel.sku,
                        "quantity": barrel.quantity        
            ...
            if barrel[2] <= 5000 and  (barrel.price * barrel.quantity) < wallet:
                purchased.append(
                    {
                        "sku": barrel.sku,
                        "quantity": barrel.quantity        
            ...
            if barrel[3] <= 5000 and (barrel.price * barrel.quantity) < wallet:
                purchased.append(
                    {
                        "sku": barrel.sku,
                        "quantity": barrel.quantity        
